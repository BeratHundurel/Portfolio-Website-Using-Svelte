<script lang="ts">
	...
	const gltf = useGltf<GLTFResult>('robot/robot.gltf');
...
<T is={ref} dispose={false} {...$$restProps} bind:this={$component}>
	...
	{:then gltf}
		<T.Group name="Sketchfab_Scene">
			<T.Group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={0.2}>
				<T.Group name="000846fff9e546569ee038af7e24655afbx" rotation={[Math.PI / 2, 0, 0]}>
					<T.Group name="Object_2">
						<T.Group name="RootNode">
							<T.Group name="holo" scale={1.88}>
								<T.Group
									name="group36"
									position={[0.33, 0, -0.1]}
									...
									scale={0.99}
								>
									<T.Group name="group39" rotation={[0, 0.88, 0]}>
										<T.Group name="group37" position={[-4.63, 14.29, 1.99]}>
											<T.Group
												name="group31"
												...
												scale={1.18}
											>
												<T.Group name="pPlatonic3" position={[-0.35, -0.12, -0.32]} scale={0}>
													<T.Mesh
												...
												>
													<T.Group name="group38" position={[0.04, 0.75, 0.25]}>
														<T.Group
															name="group29"
															position={[-0.03, -10.24, -0.04]}
															rotation={[0, Math.PI / 4, 0]}
														>
															<T.Group name="group21" position={[-12.69, 10.7, 0]} scale={0.24}>
																<T.Group
																...
																<T.Group name="group14" rotation={[0, 1.13, 0]}>
																	<T.Group name="group30" rotation={[0.49, 0, 0]} scale={3.17}>
																		<T.Group name="pSuperShape2" scale={2.08}>
																			<T.Mesh
																		...
																		<T.Group name="pSuperShape3" scale={2.08}>
																			<T.Mesh
														...
														>
															<T.Group name="group21_1" position={[-12.69, 10.7, 0]} scale={0.24}>
																<T.Group
																...
																<T.Group name="group14_1" rotation={[0, 1.13, 0]}>
																	<T.Group
																		name="group7"
														...
														>
															<T.Group name="group20" position={[-12.69, 10.7, 0]} scale={0.24}>
																<T.Group
																...
																<T.Group name="group13" rotation={[0, 1.13, 0]}>
																	<T.Group
																		name="group6"
																		position={[0, 0.03, 0]}
																		rotation={[0.48, 0.1, 0]}
														...
														>
															<T.Group name="group19" position={[-12.69, 10.7, 0]} scale={0.24}>
																<T.Group
																...
																<T.Group name="group12" rotation={[0, 1.13, 0]}>
																	<T.Group
																		name="group4"
																		...
																		scale={1.55}
																	>
																		<T.Group name="pPyramid1" scale={[5.26, 7.64, 5.26]}>
																			<T.Mesh
																		...
																		<T.Group name="pPyramid2" scale={[5.57, 8.09, 5.57]}>
																			<T.Mesh
														...
														<T.Group
															...
															rotation={[-Math.PI, -Math.PI / 4, -Math.PI]}
														>
															<T.Group name="group18" position={[-12.69, 10.7, 0]} scale={0.24}>
																<T.Group
																...
																<T.Group name="group11" rotation={[0, 1.13, 0]}>
																	<T.Group name="group5" rotation={[0.22, 0.16, 0.93]} scale={1.89}>
														...
														<T.Group
															...
															rotation={[0, -Math.PI / 4, 0]}
														>
															<T.Group name="group16" position={[-12.69, 10.7, 0]} scale={0.24}>
																<T.Group
																...
																<T.Group name="group9" rotation={[0, 1.13, 0]} scale={1.3}>
																	<T.Group name="group2" rotation={[-0.62, -0.62, 0.1]}>
																		<T.Group name="pCube1" scale={4.81}>
																			<T.Mesh
																				name="pCube1_holo1_0"
																		...
																		<T.Group name="pCube2" scale={4.92}>
																			<T.Mesh
																				name="pCube2_holo1_0"
														...
														<T.Group name="group22" position={[-0.03, -10.24, -0.04]}>
															<T.Group name="group15" position={[-12.69, 10.7, 0]} scale={0.24}>
																<T.Group
																...
																<T.Group name="group8" rotation={[0, 1.13, 0]}>
																	<T.Group
																		name="group1"
																		rotation={[-0.51, 0, 0]}
																		scale={[1.22, 0.98, 1.22]}
																	>
																		<T.Group name="pCylinder2" scale={3.57}>
																			<T.Mesh
																		...
																		<T.Group name="pCylinder3" scale={3.67}>
																			<T.Mesh
													...
													<T.Group
														...
														rotation={[0, -Math.PI / 2, 0]}
													>
														<T.Group name="group17" position={[-12.36, 11.8, 0.23]} scale={0.3}>
															<T.Group name="group10" rotation={[Math.PI, -1.16, Math.PI]}>
																<T.Group name="group3" scale={1.44}>
																	<T.Group name="pPlatonic1" scale={3.24}>
																		<T.Mesh
																	...
																	<T.Group name="pPlatonic2" scale={3.41}>
																		<T.Mesh
								...
								<T.Group name="ground" position={[0, 0.39, 0]}>
									<T.Group name="pPipe4" position={[0, -0.43, 0]} rotation={[0, -0.31, 0]}>
										<T.Group name="MASH1_ReproMesh2" position={[0, 0.43, 0]}>
											<T.Mesh
									...
									<T.Group name="pPipe2" position={[0, -0.58, 0]} rotation={[0, 0.31, 0]}>
										<T.Group
										...
										<T.Group name="pPipe3" rotation={[0, 0.68, 0]} scale={0.86}>
											<T.Mesh
												name="pPipe3_holo1_0"
									...
									<T.Group name="pPipe1" rotation={[0, -0.31, 0]}>
										<T.Group name="MASH1_ReproMesh1" scale={[1.03, 1, 1.03]}>
											<T.Mesh
									...
									<T.Group name="pDisc1" position={[0, -0.39, 0]} scale={11.11}>
										<T.Mesh
											name="pDisc1_holo1_0"
							...
							<T.Group name="bot_geo">
								...
								<T.Group name="face">
									<T.Group name="eyeCloseKawaii" position={[-13.61, -3.32, -2.9]} scale={1.29} />
									<T.Group name="eye" position={[0.41, -4.26, -1.92]} scale={1.16} />
									<T.Group name="eyeSmile" position={[-13.48, -3.21, -2.25]} scale={1.15} />
									<T.Group name="eyeClose" position={[-16, 1.37, -1.5]} />
									<T.Group name="happy" position={[-13.39, -0.05, -1.52]} />
									<T.Group name="smile" position={[0, 0, -1.52]} />
									<T.Group name="o" position={[-13.39, 1.37, -1.25]} />
									<T.Group name="close" position={[-13.39, -0.04, -1.52]} />
									<T.Group name="group34" rotation={[-Math.PI, 0, 0]} scale={-1}>
										<T.Group name="eyeCloseKawaii1" position={[-13.61, -3.32, -2.9]} scale={1.29} />
										<T.Group
											name="eye1"
										...
										/>
										<T.Group name="eyeSmile1" position={[-13.48, -3.21, -2.25]} scale={1.15} />
										<T.Group name="eyeClose1" position={[-16, 1.37, -1.5]} />
									</T.Group>
								</T.Group>
								<T.Group name="arm2" />
							</T.Group>
								...
								<T.Group name="Main">
									<T.Group name="DeformationSystem">
										<T.Group name="Object_159">
											...
											<T.Group name="Object_203" position={[-13.61, -3.32, -2.9]} scale={1.29} />
											<T.Group name="Object_205" position={[0.41, -4.26, -1.92]} scale={1.16} />
											<T.Group name="Object_207" position={[-13.48, -3.21, -2.25]} scale={1.15} />
											<T.Group name="Object_209" position={[-16, 1.37, -1.5]} />
											<T.Group name="Object_211" position={[-13.39, -0.05, -1.52]} />
											<T.Group name="Object_213" position={[0, 0, -1.52]} />
											<T.Group name="Object_215" position={[-13.39, 1.37, -1.25]} />
											<T.Group name="Object_217" position={[-13.39, -0.04, -1.52]} />
											<T.Group
												name="Object_219"
												position={[13.61, -3.32, -2.9]}
												scale={[-1.29, 1.29, 1.29]}
											/>
											<T.Group name="Object_221" position={[5.68, -4.26, -1.92]} scale={1.16} />
											<T.Group
												name="Object_223"
												position={[13.48, -3.21, -2.25]}
												scale={[-1.15, 1.15, 1.15]}
											/>
											<T.Group name="Object_225" position={[16, 1.37, -1.5]} scale={[-1, 1, 1]} />
